...
<body>
    <div id="mySidenav" class="sidenav">
        ...
        <a href="../user/user.php" class="icon-a"><i class="fa fa-dashboard icons"></i>&nbsp;&nbsp;Genrate Pass </a>
        <a href="../managepass.php" class="icon-a"><i class="fa fa-users icons"></i>&nbsp;&nbsp;Manage Pass </a>
            ...
            <div class="col-div-6">
                <div class="profile">
                    ...
                    <div class="profile-text">
                        <?php
                        // Display the user's full name from the database
                        echo $row['full_name'];
                        ?>
                    </div>
                </div>
