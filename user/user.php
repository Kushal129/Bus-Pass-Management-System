...
<body>
    ...
    <script>
        function addFileInputValidation(inputId, errorId, maxSizeKB) {
            ...
            inputElement.addEventListener('change', function() {
                ...
                if (!allowedExtensions.test(file.name)) {
                    errorElement.textContent = 'Invalid file type. Allowed: JPG, JPEG, PNG';
                    inputElement.value = '';
                    return;
                }
        ...
        addFileInputValidation('student_address_proof_upload', 'student-address-proof-error', 200);
        addFileInputValidation('filename1', 'photo-upload-error', 200);
        addFileInputValidation('handicap_photo', 'handicap-photo-upload-error', 200);
        addFileInputValidation('handicap_address_proof_upload', 'handicap-address-proof-upload-error', 200);
    </script>
    <script>
