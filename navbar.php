...
// 1 - user and 0 - admin
            ...
            echo '<script>showToaster("login not found" , "red")</script>';
        ...
        echo '<script>showToaster("Email not found")</script>';
    }
}
...
<body>
    ...
    <script>
        ...
        document.getElementById('signupLink').addEventListener('click', function() {
            ...
            document.getElementById('loginModalLabel').innerText = 'Registration'; // Change modal title to "Registration"
        ...
        document.getElementById('signinLink').addEventListener('click', function() {
            ...
            document.getElementById('loginModalLabel').innerText = 'Login'; // Change modal title back to "Login"
