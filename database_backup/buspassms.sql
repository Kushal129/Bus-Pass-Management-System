...
-- Date: Mon, 30 Oct 2023 10:58:37 +0100
...
-- Dumped table `pass` with 66 row(s)
--
...
SET autocommit=0;
INSERT INTO `passenger_info` VALUES (192,'Aruna Pipaliya','yy',196,'Male',0,219,22,'2024-04-29','2004-08-18','202310295895kp (1).jpeg'),(193,'Fenil Sonani','HAri Hari',197,'Male',0,220,18,'2024-04-30','2004-08-12','../uploads/kp (1).jpeg'),(195,'Rohan Narigara','ADjk',199,'Male',0,222,24,'2024-04-30','2002-09-12','202310304496kp (1).jpeg'),(196,'Rohan Narigara','ADjk',200,'Male',0,223,24,'2024-04-30','2002-09-12','202310309132kp (1).jpeg'),(197,'Rohan Narigara','ADjk',201,'Male',0,224,24,'2024-04-30','2002-09-12','202310309496kp (1).jpeg'),(198,'Rohan Narigara','ADjk',202,'Male',0,225,24,'2024-04-30','2002-09-12','202310301159kp (1).jpeg'),(199,'Rohan Narigara','ADjk',203,'Male',0,226,24,'2024-04-30','2002-09-12','202310309820kp (1).jpeg'),(200,'Rohan Narigara','ADjk',204,'Male',0,227,24,'2024-04-30','2002-09-12','202310304521kp (1).jpeg'),(201,'Rohan Narigara','ADjk',205,'Male',0,228,24,'2024-04-30','2002-09-12','202310303340kp (1).jpeg'),(202,'Rohan Narigara','ADjk',206,'Male',0,229,24,'2024-04-30','2002-09-12','202310302269kp (1).jpeg'),(203,'Rohan Narigara','ADjk',207,'Male',0,230,24,'2024-04-30','2002-09-12','202310304614kp (1).jpeg'),(204,'Rohan Narigara','ADjk',208,'Male',0,231,24,'2024-04-30','2002-09-12','202310304905kp (1).jpeg'),(205,'Rohan Narigara','ADjk',209,'Male',0,232,24,'2024-04-30','2002-09-12','202310304914kp (1).jpeg'),(206,'Rohan Narigara','ADjk',210,'Male',0,233,24,'2024-04-30','2002-09-12','202310302498kp (1).jpeg'),(207,'Rohan Narigara','ADjk',211,'Male',0,234,24,'2024-04-30','2002-09-12','202310308894kp (1).jpeg'),(208,'Rohan Narigara','ADjk',212,'Male',0,235,24,'2024-04-30','2002-09-12','202310309154kp (1).jpeg'),(209,'Rohan Narigara','ADjk',213,'Male',0,236,24,'2024-04-30','2002-09-12','202310305995kp (1).jpeg'),(210,'Rohan Narigara','ADjk',214,'Male',0,237,24,'2024-04-30','2002-09-12','202310308120kp (1).jpeg'),(211,'Rohan Narigara','ADjk',215,'Male',0,238,24,'2024-04-30','2002-09-12','202310306176kp (1).jpeg'),(212,'Rohan Narigara','ADjk',216,'Male',0,239,24,'2024-04-30','2002-09-12','202310301647kp (1).jpeg'),(213,'Rohan Narigara','ADjk',217,'Male',0,240,24,'2024-04-30','2002-09-12','202310309233kp (1).jpeg');
/*!40000 ALTER TABLE `passenger_info` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `passenger_info` with 21 row(s)
--
...
CREATE TABLE `users` (
  ...
  `user_img_path` varchar(255) NOT NULL DEFAULT '""',
  PRIMARY KEY (`email`),
  UNIQUE KEY `id` (`id`)
...
SET autocommit=0;
INSERT INTO `users` VALUES (23,'Vishvas Monapara',8320550560,'21bmiit127@gmail.com','$2y$10$8DlZGvltL1JbJjeOi5NhUOwe8iklIxQ7aU.YVoE02PZ5P.r.tx96i',1,'\"\"'),(1,'Admin',1234567891,'21bmiit129@gmail.com','$2y$10$omAf0m3yrxH/cFklDaeIj.fnVTQxAxV6cNjv3a0DM5MTRzawacrou',0,''),(19,'Nancy Monpara',7990589392,'21bmiit134@gmail.com','$2y$10$lvqiA0yhDX664OxVdFNGKOkPZ1BQM1fmPZ4/s9brFLYyMusPjwRFW',1,''),(24,'rohan Narigara',7894561239,'21bmiit137@gmail.com','$2y$10$AILqKVTy62bP8K3o7gRhUu0TsG3Vj2WQYPZ7Og1tQwcbqIdbIICmC',1,'202310309233kp (1).jpeg'),(22,'Aruna Pipaliya',9913402465,'abc@gmail.com','$2y$10$NGkvSEyyivA/9rCm/44lbes7NbKO46n096sOhaBCCLxNY6qI43Hma',1,''),(21,'Aruna Pipaliya',9099260609,'annu01@gmail.com','$2y$10$o5GcQMI/IGH92lF1Vhfu3Ok5OwpUyjDBj8VUHqF2f8UCl.susD.FK',1,''),(20,'Henvi kaklotar',9913402465,'henvi08@gmail.com','$2y$10$w9SrwUkHdwp9cH.Ej.wxKewj8zPzEAC1eesgXlBq.VxzdVBaGQjEe',1,''),(18,'Fenil Sonani G',9574476496,'kushalhpipaliya01@gmail.com','$2y$10$3Tcnl8tCbgk57TSl25gqhO.eB6XyhM6W6BQf6F2GchMIWHK/ksb1m',1,'');
...
-- Dump completed on: Mon, 30 Oct 2023 10:58:37 +0100
